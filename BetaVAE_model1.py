...
loss = ELBO + alpha*classifier_loss
...
with tf.Session() as sess:
    ...
    for epoch in range(6000):
        ...
        # if not i % 200:
        _, tot_loss, loss_likelihood, loss_divergence, closs = \
            sess.run((train_op, loss, marginal_likelihood, KL_divergence, classifier_loss),
    ...
    saver.save(sess, 'B11/vae11')
    print("Model saved")

with open('resultB11.pckl','wb') as f:
